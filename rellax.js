  ...
  var Rellax = function (el, options) {
    ...
    var animate = function () {
      ...
      for (var i = 0; i < self.elems.length; i++) {
        ...
        var frameNode = self.elems[i].parentNode;
        var frameHeight = frameNode.clientHeight || frameNode.offsetHeight || frameNode.scrollHeight;
        var frameTop = frameNode.getBoundingClientRect().top + posY;
